    ...
    >
      <div className="w-full max-w-sm space-y-3">
        ...
        <div className="backdrop-blur-md bg-white/50 border border-white/40 rounded px-10 pt-10 pb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            <input
              ...
              required
              className="w-full bg-[#fafafa] border border-[#dbdbdb] rounded text-sm text-[#262626] px-3 py-2 focus:outline-none focus:border-[#a8a8a8] placeholder:text-[#8e8e8e]"
            />
            <input
              type="password"
              placeholder="Hasło"
          ...
          <div className="flex items-center my-5">
            ...
            <span className="px-4 text-xs font-semibold text-[#737373] tracking-wider">LUB</span>
            <div className="flex-1 h-px bg-[#dbdbdb]" />
          </div>

          <p className="text-center text-xs text-[#737373] mt-3">
            <Link href="/forgot-password" className="text-[#00376b] font-semibold hover:underline">
              Nie pamiętasz hasła?
            </Link>
          </p>
        </div>
        ...
        <div className="backdrop-blur-md bg-white/50 border border-white/40 rounded py-4 text-center text-sm text-[#262626]">
          Nie masz konta?{' '}
          <Link href="/register" className="text-[#0095f6] font-semibold hover:underline">
            Zarejestruj się
          </Link>
        </div>
      </div>
