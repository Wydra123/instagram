    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <header className="bg-white border-b border-[#dbdbdb] sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <svg viewBox="0 0 186 44" className="w-28" fill="currentColor" aria-label="Instagram">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={logout}
              className="text-sm text-[#0095f6] font-semibold hover:text-[#00376b]"
            >
              Wyloguj
            </button>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 pt-8">
        <div className="flex flex-col items-center text-center gap-2 py-16 text-[#737373]">
          ...
          <p className="text-sm">Feed jest w trakcie budowy. Zalogowałeś się pomyślnie.</p>
        </div>
      </main>
    </div>
  );
