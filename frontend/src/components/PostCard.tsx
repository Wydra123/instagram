    ...
    <div className="bg-white border border-[#dbdbdb] rounded-xl overflow-hidden">
      ...
      {isOwn && (
        <div className="flex items-center justify-end gap-2 px-4 pb-4">
          <button
            onClick={() => onEdit(post)}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-[#0095f6] text-white rounded-lg hover:bg-[#1877f2] transition-colors"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold border border-red-200 text-red-500 rounded-lg hover:bg-red-50 transition-colors"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
